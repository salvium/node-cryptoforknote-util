  ...
  public:
    ...
    BEGIN_SERIALIZE()
      ...
      if (blob_type == BLOB_TYPE_CRYPTONOTE_SALVIUM) {
        ...
        if (type != cryptonote::salvium_transaction_type::UNSET &&
          ...
          if (type != cryptonote::salvium_transaction_type::MINER) {
            if (type == cryptonote::salvium_transaction_type::TRANSFER && version >= TRANSACTION_VERSION_N_OUTS) {
              ...
              if ((type == cryptonote::salvium_transaction_type::STAKE || type == cryptonote::salvium_transaction_type::CREATE_TOKEN) &&
        ...
        if (type == cryptonote::salvium_transaction_type::CREATE_TOKEN) {
          FIELD(token_metadata)
        } else if (type == cryptonote::salvium_transaction_type::TRANSFER) {
          FIELD(rollup_binding_tag)
        } else if (type == cryptonote::salvium_transaction_type::ROLLUP) {
          FIELD(rollup_binding_tag)
